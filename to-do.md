...
- 2026-02-10: Added sessionStorage caching for Spotify playlist data on select-sources page (5-min TTL). Back navigation and "Start Another Transfer" now load instantly from cache instead of re-fetching from Spotify API.
